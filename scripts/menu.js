            ...
            <div class="tastey-meal" data-id='${id}' data-like="${like}" data-discount="${price.discount ?? 0}">
                    <div class="tastey-meal-content">
                        <div class="tastey-meal-image-wrapper">
                            <img class="tastey-meal-image" src="${picSrc}" loading="lazy" alt="Image of ${label}" title="${label}">
                            ...
                            <button type="button" title="${like ? "Tap to unlike" : "Tap to like!"}" class="heart-icon-wrapper">
                    ...
                    <div class="checkout-section-content">
                        ...
                        <div class="order-summary">
                            <div class="order-preview">
                                ...
                                <span>
                                    <p> Orders in total :</p>
                                    <p class="cart-number">${standardize(Tastey.ordersInTotal ?? 0)}</p>
                                </span>
                                <span>
                                    <p>Tastey meals :</p>
                                    <p class="meals-number">${standardize(Tastey.tasteyMeals) ?? 0}</p>
                                </span>
                                <span>
                                    <p>Actual Amount :</p>
                                    <p class="actual-price">${formatValue(currency, Tastey.actualAmount) ?? 0}</p>
                                </span>
                                <span>
                                    <p>Total Discount :</p>
                                ...
                                <span>
                                    <p>Saved :</p>
                                    <p class="saved">${formatValue(currency, Tastey.savedAmount) ?? 0}</p>
                                </span>
                            </div>
                            <div class="order-preview">
                                ...
                                <span>
                                    <p>Total Amount</p>
                                    <p class="total-price">${formatValue(currency, Tastey.totalAmount) ?? 0}</p>
                                </span>
                                <span>
                                    <p>VAT</p>
                        ...
                        <div class="checkout">
                            <div class="checkout-preview">
                                ...
                                <span class="total-amount-values">
                                    <p class="TOTAL-COST">${formatValue(currency, Tastey.totalCost)}</p>
                                </span>
                            </div>
      ...
      orderReviewSectionContent.innerHTML += `
                <div class="tastey-meal-order" data-id="${id}" data-like="${Tastey.getLikeValue(id) ?? false}" data-orders="${standardize(orders)}" data-discount="${price.discount ?? 0}">
                    ...
                    <div class="tastey-order-image-wrapper">
                        <img class="tastey-order-image" src="${picSrc}" loading="lazy" alt="Image of ${label}" title="${label}">
                        <span class="tooltip-text like-tooltip">Double tap to like!</span>
                        <span class="tooltip-text unlike-tooltip">Double tap to unlike</span>
                    </div>
                        ...
                        <div class="tastey-order-price-wrapper">
                            <span>
                                <span class="cart-toggle">
                                    <button type="button" title="Remove 1 ${formatLabel(label, 1)}" class="sign minus${orders > 1 ? " hover" : ""}">
                                    ...
                                    <p class="cart-order-number" contenteditable="plaintext-only">${standardize(orders)}</p>
                                    <button type="button" title="Add 1 ${formatLabel(label, 1)}" class="sign add hover${orders >= maxOrders ? " disabled" : ""}" tabindex="${orders >= maxOrders ? -1 : 0}">
