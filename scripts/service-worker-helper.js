...
export function notificationQuery(title, options) {
    options.icon = "/RESTATURANT_THEMED_SITE/assets/tastey-meal-icons/tastey-icon.jpeg"
    options.badge = "/RESTATURANT_THEMED_SITE/assets/tastey-meal-icons/tastey-icon.png"
    options.actions = [
        {
            action: "open-reservation",
            title: "Make a Reservation",
            type: "button",
            icon: "/RESTATURANT_THEMED_SITE/assets/tastey-meal-icons/reservation-icon.png"
        },
        {
            action: "open-menu",
            title: "Open Tastey Menu",
            type: "button",
            icon: "/RESTATURANT_THEMED_SITE/assets/tastey-meal-icons/menu-icon.svg"
        }
    ]
